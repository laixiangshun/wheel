...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value = "ESAddConditionDTO", description = "elasticsearch添加数据入参")
public class ESAddConditionDTO {
    ...
    @ApiModelProperty(value = "jsonList", name = "添加数据json集合", required = true)
