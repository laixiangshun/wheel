...
import com.lxs.bigdata.pay.rest.param.FormParam;
import com.lxs.bigdata.pay.rest.param.HeaderParam;
import com.lxs.bigdata.pay.rest.param.Path;
import com.lxs.bigdata.pay.rest.param.QueryParam;
import com.lxs.bigdata.pay.rest.type.Delete;
import com.lxs.bigdata.pay.rest.type.Get;
import com.lxs.bigdata.pay.rest.type.Post;
import com.lxs.bigdata.pay.rest.type.Put;
...
public abstract class Client {
    ...
    private ResponseValue postForm(Path path, QueryParam queryParam, FormParam formParam, HeaderParam headerParam) {
        ...
        try {
            log.debug("Prepare to post to {} with query {}, form {} and header {}.", path, queryParam, formParam, headerParam);
    ...
    public ResponseValue postJson(Path path, QueryParam queryParam, String jsonParam, HeaderParam headerParam) {
        ...
        try {
            log.debug("Prepare to post to {} with query {}, body {} and header {}.", path, queryParam, jsonParam, headerParam);
    ...
    public ResponseValue postXml(Path path, QueryParam queryParam, String xmlParam, HeaderParam headerParam) {
        ...
        try {
            log.debug("Prepare to post to {} with query {}, body {} and header {}.", path, queryParam, xmlParam, headerParam);
    ...
    public ResponseValue get(Path path, QueryParam queryParam, HeaderParam headerParam) {
        ...
        try {
            log.debug("Prepare to get from {} with query {} and header {}.", path, queryParam, headerParam);
    ...
    private ResponseValue putForm(Path path, QueryParam queryParam, FormParam formParam, HeaderParam headerParam) {
        ...
        try {
            log.debug("Prepare to put to {} with query {}, form {} and header {}.", path, queryParam, formParam, headerParam);
    ...
    public ResponseValue putJson(Path path, QueryParam queryParam, String jsonParam, HeaderParam headerParam) {
        ...
        try {
            log.debug("Prepare to put to {} with query {}, body {} and header {}.", path, queryParam, jsonParam, headerParam);
    ...
    public ResponseValue putXml(Path path, QueryParam queryParam, String xmlParam, HeaderParam headerParam) {
        ...
        try {
            log.debug("Prepare to put to {} with query {}, body {} and header {}.", path, queryParam, xmlParam, headerParam);
    ...
    public ResponseValue delete(Path path, QueryParam queryParam, HeaderParam headerParam) {
        ...
        try {
            log.debug("Prepare to delete {} with query {} and header {}.", path, queryParam, headerParam);
    ...
    private ResponseValue toResponseValue(Response response) {
        ...
        log.debug("Response status is {}.", status.getStatusCode());
