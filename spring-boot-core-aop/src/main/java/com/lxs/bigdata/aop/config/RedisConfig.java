package com.lxs.bigdata.aop.config;
...
//        RedisCacheManager rcm = new RedisCacheManager(writer, configuration);
//        return rcm;
        ...
        return RedisCacheManager.builder(RedisCacheWriter.nonLockingRedisCacheWriter(Objects.requireNonNull(redisTemplate.getConnectionFactory())))
                .cacheDefaults(redisCacheConfiguration).disableCreateOnMissingCache().build();
    }
